...
k = 0
n01028378123 = input("input the target number : ")
pieces81237 = int(input("input the pieces : "))
# 238124012379123headers
headers_qoala = {
...
for k in range(jumlah):
  ...
  if "Send successfully" in pos_carsome:
    print("wawcool772727crsm >",k)
  else:
    print("badrspsnscrsm88181 >",k)
